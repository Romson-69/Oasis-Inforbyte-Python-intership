...
class BMICalculator:
    ...
    def determine_health_category(self, bmi: float) -> str:
        ...
        :return: Health category as string
        """
        categories = [
            (18.5, "Underweight"),
            (25, "Normal Weight"),
    ...
    def convert_units(self, value: float, unit: str, measurement_type: str) -> float:
        """
        Convert units based on measurement type.
        
        :param value: Numeric value to convert
        :param unit: Unit to convert from
        :param measurement_type: Type of measurement (weight/height)
    ...
    def compute_reference_ranges(self, height: float, weight: float) -> tuple:
        """
        Compute recommended weight and height ranges.
        
        :param height: Height in meters
        :param weight: Weight in kilograms
        :return: Tuple of weight and height ranges
        """
    ...
    def process_metrics(self):
        """
        Process input metrics and display results.
        """
        try:
